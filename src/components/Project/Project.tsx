      ...
      <div className="projects">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Exam Applicaiton for Entrance examination +2 Colleges</h3>
              <p> An application for +2 college to conduct online MCQs entrance examination through
              a learning management system based on Smart GK’s LMS Flutter, Stacked Architecture, MVVM</p>
            </div>
            <footer> <ul className="tech-list"> <li>Flutter</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Smart GK: Learning Management System Application</h3>
              <p>
              A learning Management system (LMS) based application where
 users can enroll and give government online exams and mock tests through online courses. Flutter,
 Firebase, Facebook Developer, Online Payment SDKs, river-pod
 </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Hotel App: Television Application</h3>
              <p>
              An android television application for hotel to showcase
 their facilities and significance of the local areas to foreign guests, with joint services to Flutter,
 Localisation (Translation), Firebase, SQLite (Local DB) for offline use.
 </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Salgamos: Latino Dating App</h3>
              <p>
              A latino dating app with search options and a vibrant community. Upgrade to Premium
 for unlimited likes, an ad-free experience, and expanded chat features. Download now and connect
 with confidence! React-native, JavaScript, Firebase, MongoDB, Socket.io, i18next (translator).                </p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React-Native</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Hardware Pasal: E-Commerce Application</h3>
              <p>
              Online E-commerce application for hardware suppliers, where user can browse
              and buy items. Flutter, BLoC, Cubit, Firebase, Online Payment SDKs, Clean Coding Architecture.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Medic Predict: Medical Prediction application</h3>
              <p>
              It is a predictive app that leverages advanced machine learning algorithms to
 forecast diabetes and heart disease with 90% accuracy, featuring multiple additional tools to enhance
 your health insights. Flutter, Stacked Architecture (MVVM), Firebase, Express.js, Node.js, Sci Kit
learn, Machine learning, Flask, Node Mailer.
</p>
            </div>
            <footer>
              <ul className="tech-list">
